...
Partial Public Class MainWindow
    ...
    Private Sub SaveSettings(ByVal Path As String, ByVal ThemeOnly As Boolean)
        ...
        With w
            ...
            .WriteAttributeString("gSPEED", gSPEED)
    ...
    Private Sub LoadSettings(ByVal Path As String)
        ...
        If eGrid IsNot Nothing Then
            With eGrid
                ...
                XMLLoadAttribute(.GetAttribute("gSPEED"), CGSPEED.Checked)
        ...
        Try
            ...
            If eSubMenu IsNot Nothing Then
                ...
                If eShowHide IsNot Nothing Then
                    ...
                    XMLLoadLocaleMenu(eShowHide.Item("SPEED"), CGSPEED.Text)
            ...
            If eMessages IsNot Nothing Then
                ...
                XMLLoadLocale(eMessages.Item("PromptEnterSPEED"), Strings.Messages.PromptEnterSPEED)
                ...
                XMLLoadLocale(eMessages.Item("SPEEDOverflowError"), Strings.Messages.SPEEDOverflowError)
            ...
            If eStatistics IsNot Nothing Then
                ...
                XMLLoadLocale(eStatistics.Item("lSPEED"), Strings.fStatistics.lSPEED)
